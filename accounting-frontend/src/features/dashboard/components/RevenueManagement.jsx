...
export default function RevenueManagement({ data, period, onPeriodChange, loading }) {
    ...
    return (
        <div className={`card p-4 bg-white border border-gray-200 rounded-lg h-full relative ${loading ? 'opacity-70' : ''}`}>
            {loading && (
