        ...
        <div className="h-full flex flex-col bg-white">
            ...
            {selectedReceiptForPdf && (
                <PdfPreviewModal
                    ...
                    shareData={{
                        partyName: selectedReceiptForPdf.party || "",
                        invoiceNo: selectedReceiptForPdf.referenceNumber || selectedReceiptForPdf._id || selectedReceiptForPdf.id || "",
                        amount: selectedReceiptForPdf.amount || 0,
                        type: 'receipt'
                    }}
                />
            )}
